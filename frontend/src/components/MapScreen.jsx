    ...
    return `
      <div style="min-width:240px; font-family: sans-serif; padding: 6px; color: #f3f4f6;">
        ...
        <div style="background: rgba(255,255,255,0.03); padding: 8px; border-radius: 8px; margin-bottom: 12px; border: 1px solid rgba(255,255,255,0.06);">
          ...
          <div style="display: flex; justify-content: space-between; font-size: 11px; margin-bottom: 5px;">
            <span style="color: #9ca3af;">Daily</span><span style="color: #10b981; font-weight: 700;">₹${l.price_daily}</span>
          </div>
          ${l.price_monthly ? `
          <div style="display: flex; justify-content: space-between; font-size: 11px; margin-bottom: 5px;">
            <span style="color: #9ca3af;">Monthly</span><span style="color: #e879f9; font-weight: 700;">₹${l.price_monthly}</span>
          </div>
          ` : ''}
        ...
        ${!l.is_sold ? `
          <div style="display: flex; gap: 8px;">
            <a href="${l.gmap_link}" target="_blank" style="flex: 1; background: #00d4ff; color: #06060f; padding: 8px 0; border-radius: 8px; font-size: 11px; font-weight: 700; text-align: center; text-decoration: none; border: 1px solid #00d4ff;">Navigate</a>
  ...
  return (
    <div className="h-screen w-screen flex flex-col bg-slate-900 overflow-hidden relative">
      ...
      <div className="flex-1 flex overflow-hidden relative">
          ...
          <div className="p-4 space-y-3">
            {loading && listings.length === 0 ? (
              ...
              <div className="text-center py-12 border border-dashed border-slate-800 rounded-xl">
                ...
                <span className="block text-[10px] text-slate-600 mt-1 font-mono">Try expanding search radius</span>
              </div>
            ) : (
              listings.map(l => (
                <div
                ...
                >
                  ...
                  <div className="flex flex-wrap gap-2 text-[10px] font-mono mb-2.5 bg-slate-950/40 px-2 py-1.5 rounded border border-slate-850 w-fit">
                    <span>Hourly: <strong className="text-teal-400 font-bold">₹{l.price_hourly}</strong></span>
                    <span className="text-slate-700">|</span>
                    <span>Daily: <strong className="text-emerald-400 font-bold">₹{l.price_daily}</strong></span>
                    {l.price_monthly && (
                      <>
                        <span className="text-slate-700">|</span>
                        <span>Monthly: <strong className="text-fuchsia-400 font-bold">₹{l.price_monthly}</strong></span>
                      </>
                    )}
                  </div>
        ...
        <div className={`absolute bottom-0 left-0 right-0 z-30 md:hidden bg-slate-950 border-t border-slate-800 flex flex-col transition-all duration-300 ${
          ...
          >
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-bold text-slate-300 font-mono uppercase tracking-wider">Nearby Spots</span>
              <span className="px-2 py-0.5 rounded bg-slate-900 text-[9px] font-mono text-slate-500 font-bold">
                {listings.length}
              </span>
            </div>
